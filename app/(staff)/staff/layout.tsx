...
const navItems = [
  ...
  { label: "Completed", href: "/staff/completed", icon: CheckCircle2 },
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50/50">
      ...
      <div className="flex flex-1 flex-col lg:pl-[88px]">
        {/* Mobile header */}
        <header className="sticky top-0 z-30 flex h-14 items-center justify-center border-b border-slate-200/80 bg-white/80 backdrop-blur-lg px-4 lg:hidden">
